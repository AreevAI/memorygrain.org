...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'The Open Memory Specification (OMS) v1.3: Memory Grain (.mg) Container Definition. Ten cognitive grain types (Fact, Event, State, Workflow, Tool, Observation, Goal, Reasoning, Consensus, Consent), agent-builder primitives, domain profiles, and query conventions.',
})
