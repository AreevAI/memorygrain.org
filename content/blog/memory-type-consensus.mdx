...
<Callout type="info">
The Section 27.7 pattern is a documented usage pattern, not a normative requirement. Implementations are free to use Consensus grains for Tool definition validation or to implement their own validation mechanisms. The pattern provides a standardized approach for systems that need multi-source schema agreement.
</Callout>
...
| **v1.3 pattern** | Section 27.7 — Consensus for Tool Definition Validation |
