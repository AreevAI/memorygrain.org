...
2. **Action grains** for the braking command — what deceleration was requested, what was achieved, and the content address of the triggering Observation
...
2. **Onboard compute** fuses sensor data, creates Standard-profile Action grains for actuator commands, maintains State grains for state recovery, and enforces locked Goal grains for safety constraints
