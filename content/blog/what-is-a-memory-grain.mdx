...
Tool grains provide a complete audit trail of what an agent did, what arguments it passed, what came back, and whether it succeeded. Optional fields include `duration_ms` for execution time and `error` for failure messages.
