...
Section 21.3 of the specification provides Test Vector 3, a bi-temporal Fact that illustrates how the five timestamps work together. The grain represents "Alice works at Acme Corp" with explicit temporal bounds:
