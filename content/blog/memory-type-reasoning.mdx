...
| `derived_from` | array[string] | Content addresses of parent grains (Facts, Observations, Events) |
...
<Callout type="info">
The Reasoning grain type sits at the center of the inference pipeline: Observations and Facts flow in as premises, and Facts, Goals, and Tools flow out as consequences. The `derived_from` and `related_to` fields create a bidirectional graph connecting evidence to conclusions to actions — a complete audit trail of how an agent thinks.
</Callout>
