...
The OMS specification is published under CC0 1.0 Universal (Public Domain Dedication), waiving all copyright and related rights worldwide. This means:
...
This is not incidental. An interchange format is only useful if everyone can implement it. Licensing restrictions --- even permissive ones with attribution requirements --- create friction that reduces adoption. CC0 1.0 eliminates that friction entirely.
